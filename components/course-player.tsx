                ...
                chapter && (
                  <>
                    {slide.kind === 'chapter' ? (
                      ...
                      <div
                        className={`embed-body${slide.embedUrl.startsWith('/magnetic-') || slide.embedUrl === '/dc-machine-uses-types.html' || slide.embedUrl.startsWith('/dc-motor-') ? ' embed-maxwell' : ''}${slide.embedUrl === '/ship-power-eli5.html' ? ' embed-ship-power' : ''}`}
                      >
                        <iframe
                          src={slide.embedUrl}
                          title={slide.title}

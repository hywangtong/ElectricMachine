  ...
  ...chapters.flatMap((chapter): Slide[] => {
    ...
    if (chapter.id === 'magnetic-circuits') {
      chapterSlides.push(
        ...
        {
          id: 'magnetic-circuits-gauss-electric',
          kind: 'embed',
          title: '电荷怎样产生电场？',
          chapterId: chapter.id,
          embedUrl: '/magnetic-maxwell-detail.html?law=electric',
        },
        {
          id: 'magnetic-circuits-gauss-magnetic',
          kind: 'embed',
          title: '磁场为什么没有起点和终点？',
          chapterId: chapter.id,
          embedUrl: '/magnetic-maxwell-detail.html?law=magnetic',
        },
        {
          id: 'magnetic-circuits-faraday',
          kind: 'embed',
          title: '变化的磁场怎样产生电场？',
          chapterId: chapter.id,
          embedUrl: '/magnetic-maxwell-detail.html?law=faraday',
        },
        {
          id: 'magnetic-circuits-faraday-irregular',
          kind: 'embed',
          title: '线圈不是圆环，仍会产生感生电场吗？',
          chapterId: chapter.id,
          embedUrl: '/magnetic-maxwell-detail.html?law=faraday-irregular',
        },
        {
          id: 'magnetic-circuits-ampere-maxwell',
          kind: 'embed',
          title: '真实电流怎样产生磁场？',
          chapterId: chapter.id,
          embedUrl: '/magnetic-maxwell-detail.html?law=ampere-current',
        },
        {
          id: 'magnetic-circuits-ampere-maxwell-displacement',
          kind: 'embed',
          title: '位移电流怎样产生磁场？',
          chapterId: chapter.id,
          embedUrl: '/magnetic-maxwell-detail.html?law=ampere-displacement',
        },
        {
    ...
    if (chapter.id === 'dc-machines') {
      chapterSlides.push(
        ...
        },
        {
          ...
          kind: 'embed',
          title: '例题 1：直流电动机额定运行计算',
          chapterId: chapter.id,
          embedUrl: '/dc-motor-nameplate-example.html',
        },
        {
          id: 'dc-generator-nameplate-example',
          kind: 'embed',
          title: '例题 2：直流发电机额定运行计算',
          chapterId: chapter.id,
